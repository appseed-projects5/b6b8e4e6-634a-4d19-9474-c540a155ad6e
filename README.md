...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2024-10-23 12:20`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/b6b8e4e6-634a-4d19-9474-c540a155ad6e.git
$ cd b6b8e4e6-634a-4d19-9474-c540a155ad6e
```
